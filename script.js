document.getElementById('zoomBtn').addEventListener('click', function() {
    ...
    //imagen_web.style.backgroundImage = "url('lavadora_open.png')"; 
    //imagen_web.src = 'lavadora_open.png';
    container.style.backgroundImage = "url('tu-imagen_open.jpg')";
    
    segundoFondo = !segundoFondo;
    
    setTimeout(() => {
        container.style.backgroundImage = "url('SinLavadora.jpg')"; // Cambia la imagen de fondo
                                            //fondo2.jpg
        container.style.backgroundColor = ''; // Elimina el color de fondo blanco
        container.style.Img = '';
